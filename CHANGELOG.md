...
form, each keeping the old form as a deprecated alias so nothing breaks — and a
**breaking machine-output change**: the write-failure schema is unified and the
